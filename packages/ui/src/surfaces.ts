...
export const SURFACES: readonly CloudsForgeSurface[] = [
  /* --- the six products, in the validated separation order ----------- */
  {
    ...
    blurb: 'Back what you think will happen; the contract pays the winners',
    servesUi: true,
    inSwitcher: true,
  },
  {
  ...
  },
  {
    ...
    glyph: '◐',
    markId: 'mark-trade',
    blurb: 'Try a trading strategy on past prices before you risk money',
    servesUi: true,
    inSwitcher: true,
  },
  {
  ...
  },
  {
    ...
    glyph: '◇',
    markId: 'mark-market',
    blurb: 'Buy and sell, with the money held until the buyer has the goods',
    servesUi: true,
    inSwitcher: true,
  },
  {
    ...
    glyph: '▲',
    markId: 'mark-worlds',
    blurb: 'The games, your character, and the items you own across them',
    servesUi: true,
    inSwitcher: true,
  },
