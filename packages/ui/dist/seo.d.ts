 ...
 */
import { type CloudsForgeSurface, type SurfaceKey } from './surfaces.ts';
/** The company name, as it appears in a title and in `og:site_name`. */
export declare const SITE_NAME = "CloudsForge";
/**
 ...
 */
export declare const HTML_LANG = "en-GB";
/** The company-level card, served from each surface's own `public/`. */
export declare const DEFAULT_OG_IMAGE = "/og-1200x630.png";
/**
 ...
 */
export declare const COMPANY_LINE = "Part of CloudsForge: EMBER, the chain it runs on, and every surface built on top of it.";
 ...
 */
export declare function normalisePath(pathname: string): string;
/**
 ...
 */
export declare function robotsDirective(s: CloudsForgeSurface): string;
/** A surface's description: its registry blurb, made long enough to be one. */
export declare function descriptionFor(s: CloudsForgeSurface): string;
/**
 ...
 */
export declare function surfaceMeta(key: SurfaceKey, page?: PageMetaInput): SurfaceMeta;
/**
 ...
 */
export declare function metaTags(meta: SurfaceMeta, origin: string): readonly MetaTag[];
/** The canonical link's href, absolute against the serving origin. */
export declare function canonicalHref(meta: SurfaceMeta, origin: string): string;
/**
 ...
 * write.
 */
export declare function applyHead(meta: SurfaceMeta, origin: string): void;
/** Every surface a crawler is invited to index, in registry order. */
export declare const INDEXABLE_SURFACES: readonly CloudsForgeSurface[];
