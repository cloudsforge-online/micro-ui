...
export type SurfaceKey = SwitcherKey | 'hub' | 'signin' | 'site' | 'emberkin' | 'aetherholm' | 'wallet' | 'faucet' | 'developers' | 'status' | 'explorer' | 'nimbus' | 'account' | 'api' | 'worlds-api' | 'pay' | 'keyvault';
/**
