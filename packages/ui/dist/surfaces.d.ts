...
export type SurfaceKey = SwitcherKey | 'hub' | 'signin' | 'site' | 'emberkin' | 'aetherholm' | 'tessera' | 'wallet' | 'faucet' | 'developers' | 'status' | 'explorer' | 'nimbus' | 'account' | 'api' | 'pay' | 'keyvault' | 'studio' | 'rpc' | 'p2p';
/**
