 ...
 */
function hostsFrom(origin) {
    return Object.fromEntries(SURFACES.map((s) => [s.key, `${origin(s)}${s.basePath ?? ''}`]));
}
/** Localhost ports (used for `pnpm dev` and the local docker-compose stack). */
const LOCAL_HOSTS = hostsFrom((s) => `http://localhost:${s.devPort}`);
/**
 ...
 */
export function apiBaseFor(pageOrigin, hosts, key) {
    const own = hosts[key];
 ...
 */
export function signInRedirect(returnUrl) {
 ...
 *    merely unlikely.
 */
export function attemptSilentSignIn(hasLocalSession) {
    if (typeof window === 'undefined')
        return false;
    if (hasLocalSession)
        return false;
    if (!hasSignedInHint())
        return false;
    try {
        if (window.sessionStorage.getItem(SSO_TRIED))
            return false;
    ...
    window.location.assign(`${accountUrl()}/login?return=${encodeURIComponent(back)}&silent=1`);
    return true;
}
/**
 ...
 */
export function signOutRedirect(returnUrl) {
 ...
 */
export function handoffReturnUrl(returnUrl, code) {
...
export async function consumeAuthCallback() {
    ...
    if (params.get('cf_sso') === 'none') {
        ...
        window.history.replaceState(null, '', window.location.pathname + window.location.search + (left ? `#${left}` : ''));
        return null;
    }
 ...
 */
function readCallbackTokens(body) {
...
function Caret() {
    return (_jsx("svg", { className: "cf-btn__caret", viewBox: "0 0 12 12", "aria-hidden": "true", children: _jsx("path", { d: "M2 4l4 4 4-4", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round" }) }));
}
const MARK_DRAWINGS = {
    network: () => (_jsxs(_Fragment, { children: [_jsx("path", { d: "M2 19 L7 19 M17 19 L22 19", stroke: "currentColor", opacity: ".55" }), _jsx("path", { d: "M12 2.5 C15.5 6 17 8.6 17 11.4 C17 14.5 14.8 16.6 12 16.6 C9.2 16.6 7 14.5 7 11.4 C7 8.6 8.5 6 12 2.5 Z", stroke: "var(--cf-accent, #d6412f)" }), _jsx("path", { d: "M12 9 C13.3 10.6 13.8 11.6 13.8 12.5 C13.8 13.6 13 14.3 12 14.3 C11 14.3 10.2 13.6 10.2 12.5 C10.2 11.6 10.7 10.6 12 9 Z", fill: "var(--cf-accent, #d6412f)", stroke: "none", opacity: ".5" }), _jsx("path", { d: "M7 19 L17 19", stroke: "currentColor" })] })),
    trade: () => (_jsxs(_Fragment, { children: [_jsx("path", { d: "M2 19 L22 19", stroke: "currentColor", opacity: ".55" }), _jsx("path", { d: "M3 14 L7 17 L11 10 L15 13 L21 4", stroke: "var(--cf-accent, #2a9e93)" }), _jsx("path", { d: "M15 6.5 L21 6.5", stroke: "currentColor", opacity: ".35", strokeDasharray: "2 2.5" })] })),
    create: () => (_jsxs(_Fragment, { children: [_jsx("path", { d: "M3 15 L21 15", stroke: "currentColor", opacity: ".55" }), _jsx("path", { d: "M9 15 L9 19 L15 19 L15 15", stroke: "currentColor", opacity: ".55" }), _jsx("path", { d: "M12 2 L12 11 M7.5 6.5 L16.5 6.5", stroke: "var(--cf-accent, #b28e1e)" }), _jsx("path", { d: "M8.9 3.4 L15.1 9.6 M15.1 3.4 L8.9 9.6", stroke: "var(--cf-accent, #b28e1e)", opacity: ".55" })] })),
    market: () => (_jsxs(_Fragment, { children: [_jsx("path", { d: "M2 20 L22 20", stroke: "currentColor", opacity: ".55" }), _jsx("path", { d: "M3 9 L12 4 L21 9", stroke: "var(--cf-accent, #9b7bf0)" }), _jsx("path", { d: "M3 9 L3 12 M8 9 L8 12 M12 9 L12 12 M16 9 L16 12 M21 9 L21 12", stroke: "var(--cf-accent, #9b7bf0)", opacity: ".55" }), _jsx("path", { d: "M8 20 L8 15 L16 15 L16 20", stroke: "currentColor" })] })),
    worlds: () => (_jsxs(_Fragment, { children: [_jsx("path", { d: "M2 19 L22 19", stroke: "currentColor", opacity: ".55" }), _jsx("path", { d: "M4 19 L4 13 L9 9 L14 13 L14 19", stroke: "var(--cf-accent, #6d9a49)" }), _jsx("path", { d: "M14 19 L14 15 L18 12.5 L20 14 L20 19", stroke: "var(--cf-accent, #6d9a49)", opacity: ".65" }), _jsx("path", { d: "M9 15.5 L9 16.5", stroke: "var(--cf-ember, #e8622c)" })] })),
    hub: () => (_jsxs(_Fragment, { children: [_jsx("path", { d: "M2 18 L8 11 L12 15 L16 9 L22 18", stroke: "currentColor", opacity: ".55" }), _jsx("path", { d: "M12 3.5 C13.6 5.4 14.4 6.9 14.4 8.1 C14.4 9.7 13.3 10.8 12 10.8 C10.7 10.8 9.6 9.7 9.6 8.1 C9.6 6.9 10.4 5.4 12 3.5 Z", fill: "var(--cf-ember, #e8622c)", stroke: "none" })] })),
    // The company mark. The marketing site is the front door, so it wears it unchanged.
    site: () => (_jsxs(_Fragment, { children: [_jsx("path", { d: "M3 18.5h18M5.5 18.5c1-3.4 3.4-5.2 6.5-5.2s5.5 1.8 6.5 5.2", stroke: "currentColor", opacity: ".55" }), _jsx("path", { d: "M12 3.5c1.9 2.2 3 3.9 3 5.8a3 3 0 11-6 0c0-1.2.5-2.3 1.4-3.4.5 1 .1 1.9-.2 2.6 .7-.5 1.4-1.6 1.8-5z", fill: "var(--cf-ember, #e8622c)", stroke: "none" })] })),
};
/** True when {@link Mark} will draw something for this surface. */
export function hasMark(key) {
    return key in MARK_DRAWINGS;
}
export function Mark({ surface: key, size = 24, accent, title, className }) {
    const draw = MARK_DRAWINGS[key];
    if (!draw)
        return null;
    ...
    return (_jsx("svg", { className: className ?? 'cf-mark', width: size, height: size, viewBox: "0 0 24 24", fill: "none", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", role: "img", "aria-label": label, style: style, children: draw() }));
}
/* ============================== Logo ============================== */
/**
 ...
 */
export function CloudsForgeLogo({ size = 20, markOnly = false }) {
    return (_jsxs("span", { className: "cf-logo__inner", style: { display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }, children: [_jsxs("svg", { className: "cf-logo__mark", width: size, height: size, viewBox: "0 0 24 24", role: "img", "aria-label": "CloudsForge", fill: "none", children: [_jsx("path", { d: "M3 18.5h18M5.5 18.5c1-3.4 3.4-5.2 6.5-5.2s5.5 1.8 6.5 5.2", stroke: "currentColor", strokeOpacity: "0.55", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round" }), _jsx("path", { d: "M12 3.5c1.9 2.2 3 3.9 3 5.8a3 3 0 11-6 0c0-1.2.5-2.3 1.4-3.4.5 1 .1 1.9-.2 2.6 .7-.5 1.4-1.6 1.8-5z", fill: "currentColor" })] }), !markOnly && (_jsxs("span", { className: "cf-logo__word", children: ["Clouds", _jsx("b", { children: "Forge" })] }))] }));
}
/* ========================= ProductSwitcher ======================= */
/**
 ...
 */
export function SkipLink({ targetId = MAIN_ID, children }) {
    return (_jsx("a", { className: "cf-skip", href: `#${targetId}`, children: children ?? 'Skip to content' }));
}
/**
 ...
 * setting text in it).
 */
export function StatusPill({ level, children, glyph, live, className }) {
 ...
 */
export function CookieBanner({ privacyHref, onDecide }) {
...
export function CloudsForgeFooter({ current, account, surfaceUrls, note, columns, legalUrl, }) {
    ...
    return (_jsx("footer", { className: "cf-foot", role: "contentinfo", "aria-label": "CloudsForge", children: _jsxs("div", { className: "cf-foot__inner", children: [_jsxs("div", { className: "cf-foot__cols", children: [FOOTER_GROUPS.map((group) => {
